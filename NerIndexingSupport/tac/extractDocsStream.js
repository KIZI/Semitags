/**
 * node extractDocsStream.js /Volumes/WD-DATA/NER_experiments/TAC2014/source_corpus/ /Volumes/WD-DATA/NER_experiments/TAC2014/corpus_extracted/ /Volumes/WD-DATA/NER_experiments/TAC2014/links_and_queries/tac_2013_kbp_english_entity_linking_evaluation_queries.xml
 */
...
//                        var matches = data.toString().match(/<DOC id[\s\S]*?DOC>/g);
                        match = "<doc id" + match;
                        var idMatch = match.match(/<doc id="(.*)">/);
                        if (idMatch) {
                            var id = idMatch[1];
